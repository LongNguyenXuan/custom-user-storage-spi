...
public class CustomStorageProvider implements
        UserStorageProvider,
        UserLookupProvider,
    ...
    public CustomStorageProvider(KeycloakSession session, ComponentModel model,
    ...
    public UserModel getUserByUsername(String username, RealmModel realm) {
        ...
        if (adapter == null) {
            User user = customUserStore.getUser(username);
            if (user != null) {
    ...
    public boolean isConfiguredFor(RealmModel realm, UserModel user, String credentialType) {
        ...
        try {
            String password = customUserStore.getUser(user.getUsername()).getPassword();
